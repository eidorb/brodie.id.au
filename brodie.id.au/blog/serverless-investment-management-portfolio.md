...
Oh, and if those Fort Knox banks (secured with single-factor authentication) try to block your connections originating from GitHub's ASN, you can just re-route your "hacking" via home using an [ephemeral](https://github.com/eidorb/portfolio?tab=readme-ov-file#routing-github-actions-traffic-via-a-tailscale-exit-node) [Tailscale](https://tailscale.com) VPN connection!
